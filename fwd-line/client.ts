namespace fwdSensors {
  ...
  //% fixedInstance
  export const line1 = new FwdLineFollowerClient("Line 1?srvo=0");
  //% fixedInstance
  export const line2 = new FwdLineFollowerClient("Line 2?srvo=1");
  //% fixedInstance
  export const line3 = new FwdLineFollowerClient("Line 3?srvo=2");
}
